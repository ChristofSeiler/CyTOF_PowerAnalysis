...
set.seed(0xdada)
#batchMap(reg, fun, num_latent_classes_seq)
#submitJobs(reg)
#waitForJobs(reg,sleep = 360)
#res_list = reduceResultsList(reg)
#experiments = mclapply(c(rep(5,10)),#rep(10,10),rep(15,10),rep(20,10),rep(25,10)),
#                       simulation_study,
#                       mc.cores = 8) %>% bind_rows
experiments = lapply(c(rep(25,10)),#rep(5,10),rep(15,10),rep(20,10),rep(25,10)),
